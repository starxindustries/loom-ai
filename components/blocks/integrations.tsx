...
export function Integrations() {
  ...
  return (
    <AnimatedGroup variants={transitionVariants as Variants} inView once amount={0.25} className="pb-8 pt-4 w-full text-center border-none">
      <div className="mt-16">
        <Link
          href="#link"
          className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
          <span className="text-foreground text-sm">Plays nice with your stack</span>
        ...
        <p
          ...
          Connect docs, drives, and chat. Pull context in, send actions out — zero fuss.
        </p>
      </div>
      <div
        ...
        ref={containerRef}
      >
        <div className="flex size-full flex-col max-w-5xl max-h-[200px] items-stretch justify-between gap-10">
