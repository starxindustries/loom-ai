...
5. **Google OAuth Setup** (Optional):
   ...
   a. Go to your [Supabase Dashboard](https://supabase.com/dashboard) → Authentication → Providers
   
   b. Enable Google provider and add your Google OAuth credentials:
      - **Client ID**: Your Google OAuth client ID
      - **Client Secret**: Your Google OAuth client secret
   
   c. In your Google Cloud Console, add these redirect URLs:
      - `https://your-project-ref.supabase.co/auth/v1/callback` (for production)
      - `http://localhost:3000/auth/callback` (for development)
   
   d. The Google OAuth buttons will automatically appear on your login and signup pages once configured.
