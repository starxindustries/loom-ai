-- ============================================================================
-- Fix Edge Function Call with Correct Anon Key
-- ============================================================================
...
BEGIN
  ...
  SELECT 
    ...
    ui.server_access_token,
    ui.server_refresh_token,
  ...
  BEGIN
    ...
    anon_key := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRoeXFtZ2Vra3d3bHFjd2tnc21iIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTc4NDcxOTcsImV4cCI6MjA3MzQyMzE5N30.JTIk1-xc9krrlML2hw-WW4CMZJwKeFYpukFNYJfseas';
    ...
    api_payload := jsonb_build_object(
      ...
      'integration', jsonb_build_object(
        ...
        'server_access_token', task_record.server_access_token,
        'server_refresh_token', task_record.server_refresh_token,
