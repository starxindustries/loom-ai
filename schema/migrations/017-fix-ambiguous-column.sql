-- ============================================================================
-- Fix Ambiguous Column Reference in execute_scheduled_task
-- ============================================================================
...
DECLARE
  ...
  exec_error_message TEXT; -- Renamed to avoid ambiguity
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    ...
    exec_error_message := SQLERRM; -- Use renamed variable
    
    -- Update execution log with error
    UPDATE public.task_execution_logs
    SET status = 'failed',
        completed_at = now(),
        error_message = exec_error_message -- Use renamed variable
    WHERE id = execution_log_id;
    
    -- Update task with error info and retry logic
    UPDATE public.scheduled_tasks
    SET retry_count = retry_count + 1,
        last_error = exec_error_message, -- Use renamed variable
        failed_at = now(),
        status = CASE
